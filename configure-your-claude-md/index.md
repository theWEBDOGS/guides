---
public: true
title: "Configure Your CLAUDE.md"
slug: configure-your-claude-md
verified: 2026-06-19
description: "A battle-tested starter CLAUDE.md - the verification habits, naming, and git defaults that make Claude Code reliable. Drop it in on any machine; about 5 minutes."
---
...
## Quick start (new machine) {#quick-start}
...
## What's in it - and why {#whats-in-it}
...
## Then make it yours {#make-it-yours}
